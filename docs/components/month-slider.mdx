...
import { MonthSliderExample } from "@/examples/month-slider.tsx"
...
<Tabs defaultValue="preview" className="mt-8">
  ...
  <TabsContent value="source">
    <ComponentSource source="/examples/month-slider.tsx" expanded />
  </TabsContent>
</Tabs>
...
<ComponentSource source="/components/vibrant/month-slider.tsx" />
